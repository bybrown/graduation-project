...
N17 = Node ('add', 2,1 ,@basic_add, {'n17_add'} ,{'num'});
%% 2.Connections
% IO Connections
...
Node.connect (b0_hat,1,N4,2,0);  %N4


Node.connect (x,1,N5,1,0);
Node.connect (b1_hat,1,N5,2,0); %N5

Node.connect (x,1,N6,1,0);
Node.connect (b2_hat,1,N6,2,0); %N6


Node.connect (N11,1,N7,1,0);
Node.connect (a1,1,N7,2,0); %N7


Node.connect (N11,1,N8,1,0);
Node.connect (a2,1,N8,2,0); %N8

Node.connect (N11,1,N9,1,0);
Node.connect (a1_hat,1,N9,2,0); %N9

Node.connect (N11,1,N10,1,0);
...
Node.connect (N8,1,N13,2,0); % orta , N13

Node.connect (N13,1,N12,1,1);
Node.connect (N2,1,N12,2,0);
Node.connect (N7,1,N12,3,0); % N12

Node.connect (N12,1,N11,1,1);
Node.connect (N1,1,N11,2,0);
Node.connect (N11,1,N17,1,0); 
Node.connect (N14,1,N17,2,0);
Node.connect (N17,1,y,1,0);
%% 3.Circuit Definition
input_nodes = [x,a1,a2,a1_hat,a2_hat,b0,b1,b2,b0_hat,b1_hat,b2_hat];
output_nodes = y;
circuit_nodes = [N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16,N17];

%% 4. Circuit Check
%print_circuit(input_nodes,circuit_nodes,output_nodes);

%% 5. Code Generation
gen_coder_fcn('ParallelForm_IIR_Figure1_GeneratedCode2',input_nodes,circuit_nodes,output_nodes);
